...
import com.easonstudy.Adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private void drawCenterRect(Canvas canvas) {
		...
		Paint paint1 = new Paint(Paint.DITHER_FLAG);// 创建一个画笔
		paint1.setColor(Color.parseColor("#6AADFE"));
		canvas.drawLine(0, center - offset, getWidth(), center - offset, paint1);
		canvas.drawLine(0, center + offset, getWidth(), center + offset, paint1);
	}
